// ========================================
// File: main.cpp 
// Immersed Boundary Method Benchmark (Q2 Version)
// ========================================
...
int main(){
    std::cout << "Starting IBM Benchmark Solver (Order 2)...\n";
    ...
    for (int n_elem = 20; n_elem <= 100; n_elem += 80) { 
        ...
        msh.Ordr = 2; // Updated internal tracker
        msh.generate();
        msh.checkNormals();
        ...
        for (int i = 0; i < msh.n_elements; ++i) {
            ...
            // In a Q2 element, node index [8] is precisely the center point.
            double xc = msh.Coords[conn[8]].first;
            double yc = msh.Coords[conn[8]].second;
