...
// 2. 4x4 Gauss Quadrature 
static inline void gaussQuad(int n) {
    double p1 = 0.861136311594953,  p2 = 0.339981043584856;
    double w1 = 0.347854845137454,  w2 = 0.652145154862626;

    std::vector<double> pts1D = {-p1, -p2,  p2,  p1};
    std::vector<double> wts1D = { w1,  w2,  w2,  w1};
